...
@Table(name = "dsf_gm_category")
public class DsfGmCategory implements Serializable {
	...
	public boolean equals(Object obj) {
		if (obj instanceof DsfGmCategory) {
			DsfGmCategory tGmCategory = (DsfGmCategory) obj;
