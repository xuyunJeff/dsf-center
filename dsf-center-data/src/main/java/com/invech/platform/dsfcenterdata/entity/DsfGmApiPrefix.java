...
@Table(name = "dsf_gm_api_prefix")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class DsfGmApiPrefix implements Serializable {
    ...
    public DsfGmApiPrefix(Integer apiId, String prefix, Integer siteId, Byte available, String createUser, String modifyUser) {
        this.apiId = apiId;
        this.prefix = prefix;
        this.siteId = siteId;
