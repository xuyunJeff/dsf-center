 ...
 * @Version 1.0.0
 */
public class ReplaceIntoListProvider extends SpecialProvider {

    public ReplaceIntoListProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
     ...
     * @param ms
     */
    public String replaceIntoList(MappedStatement ms) {
        final Class<?> entityClass = getEntityClass(ms);
        //开始拼sql
        StringBuilder sql = new StringBuilder();
        sql.append(ReplaceIntoListProvider.replaceIntoTable(entityClass, tableName(entityClass)));
